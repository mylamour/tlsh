...
runit() {
	...
	echo "../bin/${TLSH_PROG} -r ../data/example_data > $TMP/example_data.out 2> $TMP/example_data.err"
	      ../bin/${TLSH_PROG} -r ../data/example_data > $TMP/example_data.out 2> $TMP/example_data.err
	...
	if test $XLEN = "xlen"
	then
	echo "../bin/${TLSH_PROG} -xlen -r ../data/example_data -c ../data/example_data/website_course_descriptors06-07.txt > $TMP/example_data.scores 2> $TMP/example_data.err2"
	      ../bin/${TLSH_PROG} -xlen -r ../data/example_data -c ../data/example_data/website_course_descriptors06-07.txt > $TMP/example_data.scores 2> $TMP/example_data.err2
	else
	echo "../bin/${TLSH_PROG} -r ../data/example_data -c ../data/example_data/website_course_descriptors06-07.txt > $TMP/example_data.scores 2> $TMP/example_data.err2"
	      ../bin/${TLSH_PROG} -r ../data/example_data -c ../data/example_data/website_course_descriptors06-07.txt > $TMP/example_data.scores 2> $TMP/example_data.err2
	fi
	...
	#   warning: cannot read TLSH code ../data/example_data/BookingBrochure.txt
	if test $XLEN = "xlen"
	then
	echo "../bin/${TLSH_PROG} -xlen -l $TMP/example_data.out -c ../data/example_data/website_course_descriptors06-07.txt > $TMP/example_data.scores.2"
	      ../bin/${TLSH_PROG} -xlen -l $TMP/example_data.out -c ../data/example_data/website_course_descriptors06-07.txt > $TMP/example_data.scores.2 2>/dev/null
	else
	echo "../bin/${TLSH_PROG} -l $TMP/example_data.out -c ../data/example_data/website_course_descriptors06-07.txt > $TMP/example_data.scores.2"
	      ../bin/${TLSH_PROG} -l $TMP/example_data.out -c ../data/example_data/website_course_descriptors06-07.txt > $TMP/example_data.scores.2 2>/dev/null
	fi
	...
	echo 
	if [ $XLEN = "xlen" ]; then
	echo "../bin/${TLSH_PROG} -xref -xlen -r ../data/example_data $TMP/example_data.xref.scores"
	      ../bin/${TLSH_PROG} -xref -xlen -r ../data/example_data > $TMP/example_data.xref.scores 2>/dev/null
	else
	echo "../bin/${TLSH_PROG} -xref -r ../data/example_data $TMP/example_data.xref.scores"
	      ../bin/${TLSH_PROG} -xref -r ../data/example_data > $TMP/example_data.xref.scores 2>/dev/null
	fi
	...
	if [ $XLEN = "xlen" ]; then
	echo "../bin/${TLSH_PROG} -T 201 -xlen -l $TMP/example_data.out -c ../data/example_data/website_course_descriptors06-07.txt > $TMP/example_data.scores.2.T-201"
	      ../bin/${TLSH_PROG} -T 201 -xlen -l $TMP/example_data.out -c ../data/example_data/website_course_descriptors06-07.txt > $TMP/example_data.scores.2.T-201 2>/dev/null
	else
	echo "../bin/${TLSH_PROG} -T 201 -l $TMP/example_data.out -c ../data/example_data/website_course_descriptors06-07.txt > $TMP/example_data.scores.2.T-201"
	      ../bin/${TLSH_PROG} -T 201 -l $TMP/example_data.out -c ../data/example_data/website_course_descriptors06-07.txt > $TMP/example_data.scores.2.T-201 2>/dev/null
	fi
